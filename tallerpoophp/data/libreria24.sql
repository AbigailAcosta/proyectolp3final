--
-- Base de datos: `libreria24`
--
CREATE DATABASE IF NOT EXISTS `libreria24` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;
...
ADD PRIMARY KEY (`numero`, `id_Articulo`),
ADD KEY `fk_detalleventas_articulos1_idx` (`id_Articulo`),
...
ADD CONSTRAINT `fk_detalleventas_articulos10` FOREIGN KEY (`id_Articulo`) REFERENCES `articulos` (`id_Articulo`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `detalleventas`
--
ALTER TABLE `detalleventas`
ADD CONSTRAINT `fk_detalleventas_articulos1` FOREIGN KEY (`id_Articulo`) REFERENCES `articulos` (`id_Articulo`) ON UPDATE CASCADE,
